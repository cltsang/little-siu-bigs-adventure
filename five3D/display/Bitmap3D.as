/*//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Class inspired by Thomas Pfeiffer and Ruben Swieringa's work based on Andre Michelle's experimentations.
...
package five3D.display {
	...
	import five3D.utils.ColorUtilities;
	...
	public class Bitmap3D extends Shape {
		...
		private function setFlatShading(scene:Scene3D):void {
			...
			__normal.normalize(1);
			var dot:Number = __normal.dot(scene.ambientLightVectorNormalized);
			var brightness:Number = dot*scene.ambientLightIntensity;
			var colortransform:ColorTransform = new ColorTransform();
			ColorUtilities.setBrightness(colortransform, brightness);
